...
import { createPermissionGroup } from '../../api/permissionGroups';
import type { CreatePermissionGroupRequest } from '../../api/permissionGroups';
import { getAllPermissions, type PermissionDto } from '../../api/roles';
import { useNavigate } from 'react-router-dom';

const PermissionGroupCreate: React.FC = () => {
	const [form, setForm] = useState<CreatePermissionGroupRequest>({
		name: '',
		description: '',
		companyId: null,
		permissions: [],
	...
	return (
		<Box className="flex flex-col h-full w-full" bg="gray.50">
			<Flex justify="space-between" align="center" p={4} bg="white" borderBottom="1px solid" borderColor="gray.200" shadow="sm">
				<Heading size="lg" color="gray.700">Thêm nhóm quyền mới</Heading>
				<HStack>
					<Button 
