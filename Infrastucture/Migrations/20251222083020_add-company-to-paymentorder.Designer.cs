...
namespace Infrastucture.Migrations
{
    ...
    [Migration("20251222083020_add-company-to-paymentorder")]
    partial class addcompanytopaymentorder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entity.Partner", b =>
                {
                    ...
                    b.Property<string>("PhoneLastThreeDigits")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entity.PaymentOrder", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "DateCreated");
            ...
            modelBuilder.Entity("Domain.Entity.PermissionGroup", b =>
                {
                    ...
                    b.OwnsOne("Domain.Entity.PermissionList", "Permissions", b1 =>
                        {
                            b1.Property<Guid>("PermissionGroupId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("PermissionGroupId");

                            b1.ToTable("PermissionGroups");
