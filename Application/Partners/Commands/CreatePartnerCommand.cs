...
namespace Application.Partners.Commands
{
    ...
    public class CreatePartnerCommandHandle : IRequestHandler<CreatePartnerCommand, Unit>
    {
        ...
        public CreatePartnerCommandHandle(Domain.Service.IPartnerService partnerService, Domain.Service.IIRSequenceService sequenceService, IHttpContextAccessor httpContextAccessor, IWorkContext workContext)
        {
