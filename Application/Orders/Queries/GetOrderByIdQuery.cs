...
namespace Application.Orders.Queries
{
    ...
    class GetOrderByIdQueryHandler : IRequestHandler<GetOrderByIdQuery, OrderDto>
    {
        ...
        public GetOrderByIdQueryHandler(IHttpContextAccessor httpContextAccessor, IOrderService orderService, IWorkContext? workContext = null)
        {
        ...
        public async Task<OrderDto> Handle(GetOrderByIdQuery request, CancellationToken cancellationToken)
        {
            ...
            return new OrderDto
            {
                ...
                RemainingAmount = order.TotalPrice, // TODO: Tính từ Payment khi có
